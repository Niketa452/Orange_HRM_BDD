...
public class Utils extends BasePage {
    ...
    public static void takeScreenshot(WebDriver webdriver, String filename) {
        ...
        File destFile = new File("src\\test\\Screeenshots" + filename + randomdate() + ".png");//move image file to new destination
        try {
            copyFile(scrFile, destFile);//copy file to destinaiton.
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public void takeScreenshotBDD(Scenario scenario) throws IOException {
